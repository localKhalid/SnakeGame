...
pygame.display.set_caption('Snake Game by Khalid') #Caption text on the top of the display screen
...
def gameLoop():
    ...
    while not game_over:
        ...
        while game_close == True:
            dis.fill(red)
            message("You Lost! Would you like to play again Y or N", white)
